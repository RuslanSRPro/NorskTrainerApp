-- D09-C4 / Package 2.1
-- Distinguishes intentional admission-gate exclusions from unresolved items.
...
'Read-only, stable, fail-closed evidence snapshot for completion-contract/v1 shadow evaluation. Entity execution state is item-aware; proven function-word admission exclusions are reported separately. Service-role only.';

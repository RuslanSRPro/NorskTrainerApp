...
begin
  for v_case in select * from jsonb_array_elements(jsonb_build_array(
    ...
    jsonb_build_object('code','no_natural_language_generated','text','Han kan ringe.','check','no_nlg'),
    ...
    v_pass := case v_case->>'check'
      ...
      when 'sentence_model_immutable' then (public.analyze_text_structural_shadow_v15(v_case->>'text','runtime-structural-v1.15')#>'{document_graph,sentences,0,analysis,language_graph,sentence_model_v2}')=(v_doc#>'{document_graph,sentences,0,analysis,language_graph,sentence_model_v2}')
      when 'interpretation_immutable' then (public.analyze_text_structural_shadow_v15(v_case->>'text','runtime-structural-v1.15')#>'{document_graph,sentences,0,analysis,language_graph,interpretation_v2}')=(v_doc#>'{document_graph,sentences,0,analysis,language_graph,interpretation_v2}')
  ...
  return jsonb_build_object(
    'version','pedagogical-projection-golden-v1',
    'batch_id',v_batch,

    ...
    set
      ...
      result_summary =
        ...
        || jsonb_build_object(
          ...
          'promotion_version', 'expression_promotion_v3_semantic_rank_with_relations'
        ),
      updated_at = now()
    where i.job_id = p_job_id
    ...
    set
      ...
      result_summary =
        ...
        || jsonb_build_object(
          ...
          'lexeme_id', lm.lexeme_id,
          'promotion_version', 'verification_promotion_v4_semantic_rank_with_relations'
        ),
      updated_at = now()
    from lexeme_matches lm

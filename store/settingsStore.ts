...
function normalizeCategoryFilters(value: unknown, fallback?: CategoryFilter): CategoryFilter[] {
...
function normalizeSettings(
  ...
  const categoryFilter = settings?.category_filter || DEFAULT_SETTINGS.category_filter;
  ...
  return {
    ...
    category_filters: normalizeCategoryFilters(settings?.category_filters, categoryFilter),
...
export const useSettingsStore = create<SettingsState>((set, get) => ({
  ...
  async loadSettings() {
    try {
      ...
      const trainingLayout: TrainingLayout =
        storedLayout === 'sentence_first'
          ? 'sentence_first'
          : normalizedSettings.training_layout;
  ...
  async saveSettings() {
    try {
      ...
      if (!state.preferred_user) return;
      ...
      await saveUserSettings({
        ...
        category_filters: state.category_filters,
